...
namespace Pacem.Components.Scaffolding {
    ...
    @CustomElement({
        ...
        template: `<input type="email" class="${PCSS}-input ${PCSS}-viewfinder" />${CHAR_COUNTER_CHILD}<${ P }-a class="${PCSS}-readonly" href="{{ \'mailto:\'+ :host.value }}"><${ P }-text text="{{ :host.viewValue }}"></${ P }-text></${ P }-a>`, shadow: Defaults.USE_SHADOW_ROOT
    })
