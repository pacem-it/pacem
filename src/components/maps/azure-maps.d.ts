...
declare namespace atlas.data {
         ...
         */
        class BoundingBox extends Array<number> {
            /**
         ...
         */
        class Feature<G extends Geometry, P extends any> {
...
declare namespace atlas.control {
         ...
         */
        class CompassControl implements Control {
            /**
         ...
         */
        class PitchControl implements Control {
            /**
         ...
         */
        class StyleControl implements Control {
            /**
    ...
    //internal classes
declare namespace atlas.internal {
        /**
        ...
        abstract class EventEmitter<T = any> {
             ...
             * @param eventTypes The event types supported by this EventEmitter
             */
             ...
             */
            _addEventListener(eventType: string, callback: (e: T) => void, once: boolean): void;
            /**
             * Removes an event listener.
             * @param eventType The event name.
             * @param callback The event handler callback.
             */
            _removeEventListener(eventType: string, callback: (e: T) => void): void;
            /**
             * Returns the event types supported by this EventEmitter.
             */
            _getSupportedEvents(): string[];
            /**
             * Invokes a given event type.
             * @param eventType The event name.
             * @param eventData The data to pass to the listener callbacks.
             */
            _invokeEvent(eventType: string, eventData: T): void;
        }
    }

    //layer classes
    declare namespace atlas.layer {
        ...
        class LineLayer extends Layer {
             ...
             * @param newOptions The new options of the line layer.
             */
    ...
    //source classes
    declare namespace atlas.source {
        ...
        class DataSource extends Source {
            ...
            /**
             * Returns all shapes that are in the DataSource and which satisfy the specified filter expression.
             * @param filter a filter that will limit the query
             */
            getShapes(filter?: Expression): Shape[];
            /**
    ...
    declare namespace atlas.math {
         ...
         */
        function boundingBoxToPolygon(bounds: atlas.data.BoundingBox): atlas.data.Polygon;
        /**
         ...
         */
        function getCardinalSpline(positions: atlas.data.Position[], tension?: number, nodeSize?: number, close?: boolean): atlas.data.Position[];
        /**
         ...
         */
        function getDestination(origin: atlas.data.Position | atlas.data.Point, heading: number, distance: number, units?: string | DistanceUnits): atlas.data.Position;
        /**
         ...
         */
        function getDistanceTo(origin: atlas.data.Position | atlas.data.Point, destination: atlas.data.Position | atlas.data.Point, units?: string | DistanceUnits): number;
        /**
         ...
         */
        function getGeodesicPath(path: atlas.data.LineString | atlas.data.Position[], nodeSize?: number): atlas.data.Position[];
        /**
         ...
         */
        function getHeading(origin: atlas.data.Position | atlas.data.Point, destination: atlas.data.Position | atlas.data.Point): number;
        /**
         ...
         */
        function getLengthOfPath(path: atlas.data.LineString | atlas.data.Position[], units?: string | DistanceUnits): number;
        /**
         ...
         */
        function getPositionAlongPath(path: atlas.data.LineString | atlas.data.Position[], distance: number, units?: string | DistanceUnits): atlas.data.Position;
        /**
         ...
         */
        function getRegularPolygonPath(origin: atlas.data.Position | atlas.data.Point, radius: number, numberOfPositions: number, units?: string | DistanceUnits, offset?: number): atlas.data.Position[];
        /**
         ...
         */
        function interpolate(origin: atlas.data.Position | atlas.data.Point, destination: atlas.data.Position | atlas.data.Point, fraction?: number): atlas.data.Position;
        /**
         ...
         */
        function rotatePositions(positions: atlas.data.Position[], origin: atlas.data.Position | atlas.data.Point, angle: number): atlas.data.Position[];
        /**
         ...
         * @param destination
         */
        function getPixelHeading(origin: atlas.data.Position | atlas.data.Point, destination: atlas.data.Position | atlas.data.Point): number;
        /**
         ...
         */
        function mercatorPixelsToPositions(pixels: Pixel[], zoom: number): atlas.data.Position[];
        /**
         ...
         */
        function mercatorPositionsToPixels(positions: atlas.data.Position[], zoom: number): Pixel[];
        /**
         ...
         */
        function getAccelerationFromFeatures(origin: atlas.data.Feature<atlas.data.Point, any>, destination: atlas.data.Feature<atlas.data.Point, any>, timestampProperty: string, speedProperty?: string, speedUnits?: string | SpeedUnits, accelerationUnits?: string | AccelerationUnits, decimals?: number): number;
        /**
         ...
         */
        function getArea(data: atlas.data.Geometry | atlas.data.Feature<atlas.data.Geometry, any>, areaUnits?: AreaUnits, decimals?: number): number;
        /**
         ...
         */
        function getSpeed(origin: atlas.data.Position | atlas.data.Point | atlas.data.Feature<atlas.data.Point, any>, destination: atlas.data.Position | atlas.data.Point | atlas.data.Feature<atlas.data.Point, any>, timespan: number, timeUnits?: string | TimeUnits, speedUnits?: string | SpeedUnits, decimals?: number): number;
        /**
         ...
         */
        function getSpeedFromFeatures(origin: atlas.data.Feature<atlas.data.Point, any>, destination: atlas.data.Feature<atlas.data.Point, any>, timestampProperty: string, speedUnits?: string | SpeedUnits, decimals?: number): number;
        /**
         ...
         */
        function getConvexHull(data: atlas.data.Position[] | atlas.data.Geometry | atlas.data.Feature<atlas.data.Geometry, any> | atlas.data.FeatureCollection | atlas.data.GeometryCollection | atlas.data.Geometry[] | Array<atlas.data.Feature<atlas.data.Geometry, any>>): atlas.data.Polygon;
        /**
         ...
         */
        function getPositions(data: atlas.data.Position[] | atlas.data.Geometry | atlas.data.Feature<atlas.data.Geometry, any> | atlas.data.FeatureCollection | atlas.data.GeometryCollection | atlas.data.Geometry[] | Array<atlas.data.Feature<atlas.data.Geometry, any>>): atlas.data.Position[];
        /**
         * Gets the position of an object that is a position, point, or point feature.
         ...
         */
        function getPosition(data: atlas.data.Position | atlas.data.Point | atlas.data.Feature<atlas.data.Point, any>): atlas.data.Position;
        /**
         ...
         */
        function getPositionsAlongPath(path: atlas.data.LineString | atlas.data.Position[], numPositions: number): atlas.data.Position[];
        /**
         ...
         */
        function getPointWithHeadingAlongPath(path: atlas.data.LineString | atlas.data.Position[], distance: number, units?: string | DistanceUnits): atlas.data.Feature<atlas.data.Point, {
            heading: number;
        }>;
        /**
         ...
         */
        function getPointsWithHeadingsAlongPath(path: atlas.data.LineString | atlas.data.Position[], numPoints: number): Array<atlas.data.Feature<atlas.data.Point, {
            heading: number;
        }>>;
        /**
         ...
         * @returns
         */
        function getClosestPointOnGeometry(pt: atlas.data.Position | atlas.data.Point | atlas.data.Feature<atlas.data.Point, any>, geom: atlas.data.Geometry | atlas.data.Feature<atlas.data.Geometry, any>, units?: string | DistanceUnits, decimals?: number): atlas.data.Feature<atlas.data.Point, {
            distance: number;
        }>;
    }
...
declare namespace atlas {
    ...
    class Map {
         ...
         */
        constructor(container: string, options: ServiceOptions & StyleOptions & UserInteractionOptions & (CameraOptions | CameraBoundsOptions));
        /**
     ...
     */
    class Pixel extends Array<number> {
        /**
     ...
     */
    function setAuthenticationOptions(options: AuthenticationOptions): void;
    /**
	...
	/**
	* Sets the default tileset id used by the map and service modules unless the
	* tileset id is explicitly specified when using those parts of the API.
	* If a Map is initialized with the tileset ID explicitly defined and
	* setTilesetId hasn't previously been called it will automatically be called by the Map constructor.
	* @param id The new default tileset id.
	*/
    function setTilesetId(id: string): void;
    /**
     ...
     */
    function setSubscriptionKey(key: string): void;
    /**
     * @deprecated use atlas.setView(view: string) instead
     */
    function setUserRegion(userRegion: string): void;
    /**
 ...
 */
    interface BubbleLayerOptions extends LayerOptions {
        /**
     ...
     */
    interface LayerOptions extends Options {
        /**
    ...
    */
    interface ImageLayerOptions extends MediaLayerOptions {
        /**
    ...
    interface LineLayerOptions extends LayerOptions {
         ...
         */
        strokeGradient?: string | Expression;
        /**
         * The line's offset.
     ...
     */
    interface SymbolLayerOptions extends LayerOptions {
        /**
         * The id or instance of a data source which the layer will render.
         */
        source?: string | atlas.source.Source;
     ...
     */
    interface TileLayerOptions extends MediaLayerOptions {
        /**
     ...
     */
    interface CompassControlOptions extends Options {
        /**
     ...
     */
    interface PitchControlOptions extends Options {
        /**
     ...
     */
    interface StyleControlOptions extends Options {
        /**
         * The style of the control.
         * Default `ControlStyle.light`.
         * @default ControlStyle.light
         ...
         * Default `["road", "grayscale_dark", "night", "road_shaded_relief"]`
         * @default ["road", "grayscale_dark", "night", "road_shaded_relief"]
         */
        mapStyles?: string[];
    }
     ...
     */
    interface ZoomControlOptions extends Options {
        /**
     ...
     */
    interface AnimationOptions extends Options {
        /**
     ...
     */
    interface CameraBoundsOptions extends Options {
        /**
     ...
     */
    interface CameraOptions extends Options {
        /**
     ...
     */
    interface ControlOptions extends Options {
        /**
     ...
     * @declare namespace atlas.Object Definitions
     */
    interface DataSourceOptions extends Options {
        /**
     ...
     * @declare namespace atlas.Object Definitions
     */
    interface VectorTileSourceOptions extends Options {
        /**
         * A bounding box that specifies where tiles are available.
         * When specified, no tiles outside of the bounding box will be requested.
         */
     ...
     */
    interface PopupOptions extends Options {
        /**
     ...
     */
    interface HtmlMarkerOptions extends Options {
        /**
    ...
    interface StyleOptions extends Options {
		...
		* This option is currently only used by indoor style.
		*/
        tilesetId?: string;
    }
     ...
     */
    interface TrafficOptions extends Options {
        /**
     ...
     */
    interface UserInteractionOptions extends Options {
        /**
    ...
    */
     ...
     */
    type getAuthTokenCallback = (resolve: (value?: string) => void, reject: (reason?: any) => void, map: Map) => void;
     ...
     */
    interface AuthenticationOptions extends Options {
        /**
         ...
         */
        setAadProperties?(clientId: string, aadAppId: string, aadTenant: string, aadInstance?: string, authContext?: any): void;
        /**
     ...
     */
    interface Expression extends Array<any> {
    }
    ...
    interface EventManager {
        ...
        /**
         * Adds a drag event to the HtmlMarker(s).
         * @param eventType The drag event name.
         * @param target The HtmlMarker(s) to add the event for.
         * @param callback The event handler callback.
         */
        add(eventType: "click" | "contextmenu" | "dblclick" | "drag" | "dragstart" | "dragend" | "keydown" | "keypress" | "keyup" | "mousedown" | "mousemove" | "mouseout" | "mouseover" | "mouseup", target: atlas.HtmlMarker | atlas.HtmlMarker[], callback: (e: TargetedEvent) => void): void;
        /**
         ...
         * @param callback The event handler callback.
         */
        add(eventType: "open" | "close", target: atlas.Popup | atlas.Popup[], callback: (e: TargetedEvent) => void): void;
        /**
         * Adds a touch event to the map.
         * @param eventType The touch event name.
         * @param callback The event handler callback.
         */
        addOnce(eventType: "touchstart" | "touchend" | "touchmove" | "touchcancel", callback: (e: MapTouchEvent) => void): any;
        /**
         * Adds a mouse event to the map.
         * @param eventType The mouse event name.
         * @param callback The event handler callback.
         */
        addOnce(eventType: "mousedown" | "mouseup" | "mouseover" | "mousemove" | "click" | "dblclick" | "mouseout" | "contextmenu", callback: (e: MapMouseEvent) => void): any;
        /**
         * Adds a wheel event to the map.
         * @param eventType The wheel event name.
         * @param callback The event handler callback.
         */
        addOnce(eventType: "wheel", callback: (e: MapMouseWheelEvent) => void): any;
        /**
         * Adds an event to the map.
         * @param eventType The error event name.
         * @param callback The event handler callback.
         */
        addOnce(eventType: "error", callback: (e: MapErrorEvent) => void): any;
        /**
         * Adds an event to the map.
         * @param eventType The event name.
         * @param callback The event handler callback.
         ...
         * @param callback The event handler callback.
         */
        addOnce(eventType: "touchstart" | "touchend" | "touchmove" | "touchcancel", target: atlas.layer.Layer, callback: (e: MapTouchEvent) => void): any;
        /**
         * Adds a mouse event to the map.
         * @param eventType The mouse event name.
         * @param target The layer(s) to add the event for.
         * @param callback The event handler callback.
         */
        addOnce(eventType: "mousedown" | "mouseup" | "mouseover" | "mousemove" | "click" | "dblclick" | "mouseout" | "mouseenter" | "mouseleave" | "contextmenu", target: atlas.layer.Layer, callback: (e: MapMouseEvent) => void): any;
        /**
         * Adds a wheel event to the map.
         * @param eventType The wheel event name.
         * @param target The layer(s) to add the event for.
         * @param callback The event handler callback.
         */
        addOnce(eventType: "wheel", target: atlas.layer.Layer, callback: (e: MapMouseWheelEvent) => void): any;
        /**
         * Adds a drag event to the HtmlMarker(s).
         * @param eventType The drag event name.
         * @param target The HtmlMarker(s) to add the event for.
         * @param callback The event handler callback.
         */
        addOnce(eventType: "click" | "contextmenu" | "dblclick" | "drag" | "dragstart" | "dragend" | "keydown" | "keypress" | "keyup" | "mousedown" | "mousemove" | "mouseout" | "mouseover" | "mouseup", target: HtmlMarker, callback: (e: TargetedEvent) => void): any;
        /**
         * Adds an event to the Popup(s).
         * @param eventType The drag event name.
         * @param target The HtmlMarker(s) to add the event for.
         * @param callback The event handler callback.
         */
        addOnce(eventType: "open" | "close", target: Popup, callback: (e: TargetedEvent) => void): any;
        /**
         ...
         * @param callback The event handler callback.
         */
        remove(eventType: string, callback: (e: void | MapMouseEvent | MapTouchEvent | MapMouseWheelEvent) => void): void;
        /**
         * Removes an event listener from the map.
         * @param eventType The event name.
         ...
         * @param callback The event handler callback.
         */
        remove(eventType: string, target: atlas.layer.Layer | atlas.layer.Layer[], callback: (e: void | MapMouseEvent | MapTouchEvent | MapMouseWheelEvent) => void): void;
        /**
         ...
         * @param callback The event handler callback.
         */
        remove(eventType: string, target: atlas.HtmlMarker | atlas.HtmlMarker[], callback: (e: TargetedEvent) => void): void;
        /**
         ...
         * @param callback The event handler callback.
         */
        remove(eventType: string, target: atlas.Popup | atlas.Popup[], callback: (e: TargetedEvent) => void): void;
    }
    ...
    interface LayerManager {
		...
		/**
		* Set the floor number for indoor map.
		* This is used only in 'indoor' style.
		* @param number The floor number.
		*/
        setFloorNumber(floornum: number): void;
        /**
         ...
         */
        getRenderedShapes(geometry?: atlas.data.Position | atlas.data.Point | atlas.data.BoundingBox, layers?: Array<string | atlas.layer.Layer>, filter?: Expression): Array<atlas.Shape | atlas.data.Feature<atlas.data.Geometry, any>>;
        /**
     ...
     */
    interface MapMouseWheelEvent extends MapEvent {
        /**
     ...
     */
    interface MapTouchEvent extends MapMouseWheelEvent {
        /**
     ...
     */
    interface MapMouseEvent extends MapMouseWheelEvent {
        /**
     ...
     */
    interface Padding extends Options {
        /**
